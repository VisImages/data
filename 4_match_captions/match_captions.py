...
def parse_args():
    ...
    parser.add_argument("--paper", "-p", default="vis_data/papers", help="paper pdf documents source path", type=str)
    parser.add_argument("--src", "-s", default="3_extract_captions/precomputed", help="captions source path", type=str)
